...
export interface ISubscriptionDocument
  extends Omit<ISubscription, "_id">, Document {}
export interface ISubscriptionPeriodDocument
  extends Omit<ISubscriptionPeriod, "_id">, Document {}
...
export const SubscriptionPeriodModel =
  mongoose.model<ISubscriptionPeriodDocument>(
    "SubscriptionPeriod",
