...
export interface IUpgradeRequestDocument
  extends Omit<IUpgradeRequest, "_id">, Document {}
...
export const UpgradeRequestModel = mongoose.model<IUpgradeRequestDocument>(
  "UpgradeRequest",
