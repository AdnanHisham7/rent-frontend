...
export const createSubscriptionRouter = (
  ...
  router.post(
    ...
    validate(createBuilderSubscriptionSchema),
    controller.createBuilderSubscription,
  );
  router.patch(
    "/admin/:id",
    authorize(UserRole.SUPER_ADMIN),
  ...
  router.post(
    "/admin/periods/:periodId/pay",
    authorize(UserRole.SUPER_ADMIN),
    controller.markPeriodPaid,
  );
  router.get(
    "/admin/periods",
    authorize(UserRole.SUPER_ADMIN),
